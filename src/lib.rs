...
#[derive(Debug)]
pub struct HiveKiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HiveKiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HiveKite processing");
    
    let mut processor = HiveKiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HiveKiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HiveKiteProcessor::new(false);
